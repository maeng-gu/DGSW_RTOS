...
void inst_set(){
  unsigned char inst_settings[] = {0x30,0x30,0x30,0x38,0x06,0x0C,0x80};
  for(int j=0;j<=7;j++){
...
void data_set(){
  unsigned char data_settings[] = {0x53,0x54,0x41,0x52,0x43,0x52,0x41,0x46,0x54,0x39,0x3A,0x41,0x42,0x43,0x44,0x45
...
void data_setting(int j, unsigned char data_settings[]){
    digitalWrite(RS,1);
    digitalWrite(RW,0);
